...
void MqttHandlePowerLimiterClass::publishGridPowerDebug(int grid)
{
    {
    auto val = static_cast<signed>(grid);
    MqttSettings.publish("powerlimiter/debug/grid_power", String(val));
    }
}
